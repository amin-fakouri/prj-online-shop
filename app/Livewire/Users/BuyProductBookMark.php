...
class BuyProductBookMark extends Component
{
    ...
    #[Layout('layouts.app')]
    public function mount($id, $i)
    {
        $this->form_buy = \App\Models\BuyProduct::all();
        $this->buy_product = users_products::find($id);
        $this->zarb = $i;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.users.buy-product-book-mark');
    }
